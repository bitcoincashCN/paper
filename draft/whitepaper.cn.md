...
* gotolab：使货币汇率稳定，自动动态调节汇率，最有效的方法就是市场自由流通。
...
* gotolab：反人性设计。算法可以这么算，表示方式应该用正常方式。
...
* gotolab：对的，确定下来的算法，就不要变动，其他的交给市场去自动调节。
...
* gotolab：隐私功能有一些突破性的研究成果，比如MimbleWimble协议。可以采用分层方式实现（侧链+双向锚定），不要重复造轮子。
